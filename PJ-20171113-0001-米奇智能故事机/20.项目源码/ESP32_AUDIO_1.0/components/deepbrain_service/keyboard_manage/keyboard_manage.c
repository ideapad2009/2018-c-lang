...
#define KEY_MATRIX_IDEL_VOLTAGE		    (2214)     //空闲
#define KEY_MATRIX_K1_VOLTAGE(x)	    (204 + x) //
#define KEY_MATRIX_K2_VOLTAGE(x)	    (533 + x) //
#define KEY_MATRIX_K3_VOLTAGE(x)   		(834 + x) //
#define KEY_MATRIX_K4_VOLTAGE(x)	    (1140 + x) //
#define KEY_MATRIX_K5_VOLTAGE(x)	    (195 + x)  //
#define KEY_MATRIX_K6_VOLTAGE(x)	    (526 + x)  //
#define KEY_MATRIX_K7_VOLTAGE(x)	    (833 + x)  //
#define KEY_MATRIX_K8_VOLTAGE(x)	    (1135 + x)  //
#define KEY_MATRIX_K9_VOLTAGE(x)	    (1439 + x)  //
...
*/
	...
	{	
		switch (status->curr_key_num)
		{
			...
			case DEVICE_NOTIFY_KEY_CHAT_TAP ... DEVICE_NOTIFY_KEY_FW_UPDATE_TAP:
			{
				//key press

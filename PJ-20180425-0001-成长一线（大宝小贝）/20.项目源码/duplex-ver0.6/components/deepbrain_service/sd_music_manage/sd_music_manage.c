...
typedef enum
{
	...
	FOLDER_INDEX_CUI_MIAN_QU = 0,
	FOLDER_INDEX_ER_GE,
	FOLDER_INDEX_GU_SHI,
	FOLDER_INDEX_YIN_YUE,
	FOLDER_INDEX_GUO_XUE,
	FOLDER_INDEX_YING_YU,
	FOLDER_INDEX_YUE_QI,
	FOLDER_INDEX_END,
}FOLDER_INDEX_T;
...
static void get_prev_music(AUTO_PLAY_MUSIC_SOURCE_T *src)
{
	...
	{
		folder_index = FOLDER_INDEX_CUI_MIAN_QU;
	}
	...
	do 
	{
		...
		{
			folder_index = FOLDER_INDEX_YUE_QI;
		}
...
void sd_music_start()
{
	...
	switch (folder_index)
	{
		case FOLDER_INDEX_CUI_MIAN_QU:
		{
			player_mdware_play_tone(FLASH_MUSIC_CUI_MIAN_QU);
			break;
		}
		case FOLDER_INDEX_ER_GE:
		{
			player_mdware_play_tone(FLASH_MUSIC_ER_GE);
			break;
		}
		case FOLDER_INDEX_GU_SHI:
		{
			player_mdware_play_tone(FLASH_MUSIC_GU_SHI);
			break;
		}
		case FOLDER_INDEX_YIN_YUE:
		{
			player_mdware_play_tone(FLASH_MUSIC_YIN_YUE);
			break;
		}
		case FOLDER_INDEX_GUO_XUE:
		{
			player_mdware_play_tone(FLASH_MUSIC_GUO_XUE);
			break;
		}
		case FOLDER_INDEX_YING_YU:
		{
			player_mdware_play_tone(FLASH_MUSIC_YING_YU);
			break;
		}
		case FOLDER_INDEX_YUE_QI:
		{
			player_mdware_play_tone(FLASH_MUSIC_YUE_QI);
			break;
		}
		default:
			break;

...
struct MediaControl {
    ...
    int (*addDecoderCodecLib)(void *codec, int heap, const char *type, void *open, void *process, void *close, void *triggerStop);
    ...
    int (*getCurrentList) (struct MediaService *service);
    int (*setPlaylist)(struct MediaService *service, int listId, int modifyExisting);
    int (*saveToPlaylist)(struct MediaService *service, int listId, const char *uri);
    int (*closePlaylist)(struct MediaService *service, int listId);
    int (*clearPlaylist) (struct MediaService *service, int listId);

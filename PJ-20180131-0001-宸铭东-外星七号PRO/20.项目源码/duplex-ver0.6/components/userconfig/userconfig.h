...
*******************************************************************/
#define DEVICE_SN_PREFIX	"WXQH"
#define ESP32_FW_VERSION	"V1.1.0build20180808"
#define DEEP_BRAIN_APP_ID 	"A000000000000236"
#define DEEP_BRAIN_ROBOT_ID "06cd06c6-2599-11e8-8672-801844e30cac"
...
//OTA升级服务器地址
#define OTA_UPDATE_SERVER_URL		"http://file.yuyiyun.com:2088/ota/PJ-20180131-0001/version.txt"
//OTA升级服务器测试地址
#define OTA_UPDATE_SERVER_URL_TEST	"http://file.yuyiyun.com:2088/ota/test/PJ-20180131-0001/version.txt"
...
#define MODULE_MCU_SERIAL_COMM				0
...
#define MODULE_GELING_JIAOYU				1//格林教育点播
#define MODULE_FREE_TALK					1//连续对话模块
#define DATA_STREAM_SHARE_ENABLE 			1//录音数据共享
#define MODULE_KEYWORD_WAKEUP				1//关键词唤醒模块
...
#define EYEBROW_LED_GPIO	GPIO_NUM_32
#define EYEBROW_LED_SEL		GPIO_SEL_32
#define EYE_LED_GPIO		GPIO_NUM_33
#define EYE_LED_SEL			GPIO_SEL_33
#define CHARGING_STATE_GPIO GPIO_NUM_36
#define CHARGING_STATE_SEL  GPIO_SEL_36
#define MOUTH_LED_GPIO		GPIO_NUM_21
#define MOUTH_LED_SEL		GPIO_SEL_21
#endif

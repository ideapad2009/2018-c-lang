...
typedef struct OggVorbis_File {
  ...
  ogg_int64_t      page_packet_offset; ///every page head packet position.
  ogg_int64_t      pause_packet_idx; ///the pause position packet index. when resume, the packet between page_packet_offset and pause_packet_idx will be skip
...
extern void OggFixInfoCopy(OggVorbis_File *vf_tar, OggVorbis_File *vf_src, ov_callbacks callbacks);
extern void OggChangeInfoCopy(OggVorbis_File *vf_tar, OggVorbis_File *vf_src);

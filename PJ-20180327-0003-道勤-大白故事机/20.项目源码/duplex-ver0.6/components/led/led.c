...
{
	gpio_set_level(LED_QICAI_GPIO, 0);
}

//夜灯开关
void night_light_switch(void)
{
	int led_level = gpio_get_level(LED_NIGHT_LIGHT_GPIO);
	gpio_set_level(LED_NIGHT_LIGHT_GPIO, !led_level);
}

void night_light_off(void)
{
	gpio_set_level(LED_NIGHT_LIGHT_GPIO, 0);
}
...
void UserGpioInit()
{
    ...
    io_conf.pin_bit_mask     = LED_QICAI_SEL | LED_NIGHT_LIGHT_SEL;
